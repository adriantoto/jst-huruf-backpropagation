...
public class Testing extends javax.swing.JFrame {
    ...
    public Testing(double[] b, double[][] w, double [] biasZ, double [][] v,String[] Huruf,  int[][] t, int m, int hidden ){
        setTitle("Testing");
        initComponents();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        Dimension frameSize = getSize();
    ...
    private void initComponents() {
        ...
        tes63.setBackground(java.awt.Color.white);
        ...
        tes1.setBackground(java.awt.Color.white);
        ...
        tes2.setBackground(java.awt.Color.white);
        ...
        tes3.setBackground(java.awt.Color.white);
        ...
        tes4.setBackground(java.awt.Color.white);
        ...
        tes5.setBackground(java.awt.Color.white);
        ...
        tes6.setBackground(java.awt.Color.white);
        ...
        tes7.setBackground(java.awt.Color.white);
        ...
        tes8.setBackground(java.awt.Color.white);
        ...
        tes9.setBackground(java.awt.Color.white);
        ...
        tes10.setBackground(java.awt.Color.white);
        ...
        tes11.setBackground(java.awt.Color.white);
        ...
        tes12.setBackground(java.awt.Color.white);
        ...
        tes13.setBackground(java.awt.Color.white);
        ...
        tes14.setBackground(java.awt.Color.white);
        ...
        tes15.setBackground(java.awt.Color.white);
        ...
        tes16.setBackground(java.awt.Color.white);
        ...
        tes17.setBackground(java.awt.Color.white);
        ...
        tes18.setBackground(java.awt.Color.white);
        ...
        tes19.setBackground(java.awt.Color.white);
        ...
        tes20.setBackground(java.awt.Color.white);
        ...
        tes21.setBackground(java.awt.Color.white);
        ...
        tes22.setBackground(java.awt.Color.white);
        ...
        tes23.setBackground(java.awt.Color.white);
        ...
        tes24.setBackground(java.awt.Color.white);
        ...
        tes25.setBackground(java.awt.Color.white);
        ...
        tes26.setBackground(java.awt.Color.white);
        ...
        tes27.setBackground(java.awt.Color.white);
        ...
        tes28.setBackground(java.awt.Color.white);
        ...
        tes29.setBackground(java.awt.Color.white);
        ...
        tes30.setBackground(java.awt.Color.white);
        ...
        tes31.setBackground(java.awt.Color.white);
        ...
        tes32.setBackground(java.awt.Color.white);
        ...
        tes33.setBackground(java.awt.Color.white);
        ...
        tes34.setBackground(java.awt.Color.white);
        ...
        tes35.setBackground(java.awt.Color.white);
        ...
        tes36.setBackground(java.awt.Color.white);
        ...
        tes37.setBackground(java.awt.Color.white);
        ...
        tes38.setBackground(java.awt.Color.white);
        ...
        tes39.setBackground(java.awt.Color.white);
        ...
        tes40.setBackground(java.awt.Color.white);
        ...
        tes41.setBackground(java.awt.Color.white);
        ...
        tes42.setBackground(java.awt.Color.white);
        ...
        tes43.setBackground(java.awt.Color.white);
        ...
        tes44.setBackground(java.awt.Color.white);
        ...
        tes45.setBackground(java.awt.Color.white);
        ...
        tes46.setBackground(java.awt.Color.white);
        ...
        tes47.setBackground(java.awt.Color.white);
        ...
        tes48.setBackground(java.awt.Color.white);
        ...
        tes49.setBackground(java.awt.Color.white);
        ...
        tes50.setBackground(java.awt.Color.white);
        ...
        tes51.setBackground(java.awt.Color.white);
        ...
        tes52.setBackground(java.awt.Color.white);
        ...
        tes53.setBackground(java.awt.Color.white);
        ...
        tes54.setBackground(java.awt.Color.white);
        ...
        tes55.setBackground(java.awt.Color.white);
        ...
        tes56.setBackground(java.awt.Color.white);
        ...
        tes57.setBackground(java.awt.Color.white);
        ...
        tes58.setBackground(java.awt.Color.white);
        ...
        tes59.setBackground(java.awt.Color.white);
        ...
        tes60.setBackground(java.awt.Color.white);
        ...
        tes61.setBackground(java.awt.Color.white);
        ...
        tes62.setBackground(java.awt.Color.white);
        ...
        tes_huruf.setFont(new java.awt.Font("Courier New", 1, 18)); // NOI18N
        ...
        tes_keterangan.setFont(new java.awt.Font("Courier New", 3, 8)); // NOI18N
        ...
        jPanel2.add(tes_keterangan, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 160, 180, -1));

        tes_testing.setFont(new java.awt.Font("Courier New", 1, 18)); // NOI18N
        ...
        tes_refresh.setFont(new java.awt.Font("DejaVu Sans", 1, 14)); // NOI18N
        ...
        radio_biner.setFont(new java.awt.Font("Courier New", 1, 18)); // NOI18N
        ...
        radio_bipolar.setFont(new java.awt.Font("Courier New", 1, 18)); // NOI18N
...
public static Double DiffSigmoid2(Double x){
    ...
    private void tes1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes1ActionPerformed
        if (tes1.isSelected()) {
            tes1.setBackground(Color.BLACK);
            tes1.setText("T");
            tes1.setForeground(Color.WHITE);
        } else {
            tes1.setBackground(Color.WHITE);
            tes1.setText("F");
            tes1.setForeground(Color.BLACK);
        }
    ...
    private void tes2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes2ActionPerformed
        if (tes2.isSelected()) {
            tes2.setBackground(Color.BLACK);
            tes2.setText("T");
            tes2.setForeground(Color.WHITE);
        } else {
            tes2.setBackground(Color.WHITE);
            tes2.setText("F");
            tes2.setForeground(Color.BLACK);
        }
    ...
    private void tes3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes3ActionPerformed
       if (tes3.isSelected()) {
            tes3.setBackground(Color.BLACK);
            tes3.setText("T");
            tes3.setForeground(Color.WHITE);
        } else {
            tes3.setBackground(Color.WHITE);
            tes3.setText("F");
            tes3.setForeground(Color.BLACK);
        }
    ...
    private void tes4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes4ActionPerformed
       if (tes4.isSelected()) {
            tes4.setBackground(Color.BLACK);
            tes4.setText("T");
            tes4.setForeground(Color.WHITE);
        } else {
            tes4.setBackground(Color.WHITE);
            tes4.setText("F");
            tes4.setForeground(Color.BLACK);
        }
    ...
    private void tes5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes5ActionPerformed
        if (tes5.isSelected()) {
            tes5.setBackground(Color.BLACK);
            tes5.setText("T");
            tes5.setForeground(Color.WHITE);
        } else {
            tes5.setBackground(Color.WHITE);
            tes5.setText("F");
            tes5.setForeground(Color.BLACK);
        }
    ...
    private void tes6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes6ActionPerformed
        if (tes6.isSelected()) {
            tes6.setBackground(Color.BLACK);
            tes6.setText("T");
            tes6.setForeground(Color.WHITE);
        } else {
            tes6.setBackground(Color.WHITE);
            tes6.setText("F");
            tes6.setForeground(Color.BLACK);
        }
    ...
    private void tes7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes7ActionPerformed
        if (tes7.isSelected()) {
            tes7.setBackground(Color.BLACK);
            tes7.setText("T");
            tes7.setForeground(Color.WHITE);
        } else {
            tes7.setBackground(Color.WHITE);
            tes7.setText("F");
            tes7.setForeground(Color.BLACK);
        }
    ...
    private void tes8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes8ActionPerformed
        if (tes8.isSelected()) {
            tes8.setBackground(Color.BLACK);
            tes8.setText("T");
            tes8.setForeground(Color.WHITE);
        } else {
            tes8.setBackground(Color.WHITE);
            tes8.setText("F");
            tes8.setForeground(Color.BLACK);
        }
    ...
    private void tes9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes9ActionPerformed
        if (tes9.isSelected()) {
            tes9.setBackground(Color.BLACK);
            tes9.setText("T");
            tes9.setForeground(Color.WHITE);
        } else {
            tes9.setBackground(Color.WHITE);
            tes9.setText("F");
            tes9.setForeground(Color.BLACK);
        }
    ...
    private void tes10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes10ActionPerformed
       if (tes10.isSelected()) {
            tes10.setBackground(Color.BLACK);
            tes10.setText("T");
            tes10.setForeground(Color.WHITE);
        } else {
            tes10.setBackground(Color.WHITE);
            tes10.setText("F");
            tes10.setForeground(Color.BLACK);
        }
    ...
    private void tes11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes11ActionPerformed
        if (tes11.isSelected()) {
            tes11.setBackground(Color.BLACK);
            tes11.setText("T");
            tes11.setForeground(Color.WHITE);
        } else {
            tes11.setBackground(Color.WHITE);
            tes11.setText("F");
            tes11.setForeground(Color.BLACK);
        }
    ...
    private void tes12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes12ActionPerformed
        if (tes12.isSelected()) {
            tes12.setBackground(Color.BLACK);
            tes12.setText("T");
            tes12.setForeground(Color.WHITE);
        } else {
            tes12.setBackground(Color.WHITE);
            tes12.setText("F");
            tes12.setForeground(Color.BLACK);
        }
    ...
    private void tes13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes13ActionPerformed
        if (tes13.isSelected()) {
            tes13.setBackground(Color.BLACK);
            tes13.setText("T");
            tes13.setForeground(Color.WHITE);
        } else {
            tes13.setBackground(Color.WHITE);
            tes13.setText("F");
            tes13.setForeground(Color.BLACK);
        }
    ...
    private void tes14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes14ActionPerformed
        if (tes14.isSelected()) {
            tes14.setBackground(Color.BLACK);
            tes14.setText("T");
            tes14.setForeground(Color.WHITE);
        } else {
            tes14.setBackground(Color.WHITE);
            tes14.setText("F");
            tes14.setForeground(Color.BLACK);
        }
    ...
    private void tes15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes15ActionPerformed
      if (tes15.isSelected()) {
            tes15.setBackground(Color.BLACK);
            tes15.setText("T");
            tes15.setForeground(Color.WHITE);
        } else {
            tes15.setBackground(Color.WHITE);
            tes15.setText("F");
            tes15.setForeground(Color.BLACK);
        }
    ...
    private void tes17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes17ActionPerformed
        if (tes17.isSelected()) {
            tes17.setBackground(Color.BLACK);
            tes17.setText("T");
            tes17.setForeground(Color.WHITE);
        } else {
            tes17.setBackground(Color.WHITE);
            tes17.setText("F");
            tes17.setForeground(Color.BLACK);
        }
    ...
    private void tes18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes18ActionPerformed
        if (tes18.isSelected()) {
            tes18.setBackground(Color.BLACK);
            tes18.setText("T");
            tes18.setForeground(Color.WHITE);
        } else {
            tes18.setBackground(Color.WHITE);
            tes18.setText("F");
            tes18.setForeground(Color.BLACK);
        }
    ...
    private void tes19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes19ActionPerformed
        if (tes19.isSelected()) {
            tes19.setBackground(Color.BLACK);
            tes19.setText("T");
            tes19.setForeground(Color.WHITE);
        } else {
            tes19.setBackground(Color.WHITE);
            tes19.setText("F");
            tes19.setForeground(Color.BLACK);
        }
    ...
    private void tes20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes20ActionPerformed
        if (tes20.isSelected()) {
            tes20.setBackground(Color.BLACK);
            tes20.setText("T");
            tes20.setForeground(Color.WHITE);
        } else {
            tes20.setBackground(Color.WHITE);
            tes20.setText("F");
            tes20.setForeground(Color.BLACK);
        }
    ...
    private void tes21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes21ActionPerformed
        if (tes21.isSelected()) {
            tes21.setBackground(Color.BLACK);
            tes21.setText("T");
            tes21.setForeground(Color.WHITE);
        } else {
            tes21.setBackground(Color.WHITE);
            tes21.setText("F");
            tes21.setForeground(Color.BLACK);
        }
    ...
    private void tes22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes22ActionPerformed
        if (tes22.isSelected()) {
            tes22.setBackground(Color.BLACK);
            tes22.setText("T");
            tes22.setForeground(Color.WHITE);
        } else {
            tes22.setBackground(Color.WHITE);
            tes22.setText("F");
            tes22.setForeground(Color.BLACK);
        }
    ...
    private void tes23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes23ActionPerformed
        if (tes23.isSelected()) {
            tes23.setBackground(Color.BLACK);
            tes23.setText("T");
            tes23.setForeground(Color.WHITE);
        } else {
            tes23.setBackground(Color.WHITE);
            tes23.setText("F");
            tes23.setForeground(Color.BLACK);
        }
    ...
    private void tes24ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes24ActionPerformed
        if (tes24.isSelected()) {
            tes24.setBackground(Color.BLACK);
            tes24.setText("T");
            tes24.setForeground(Color.WHITE);
        } else {
            tes24.setBackground(Color.WHITE);
            tes24.setText("F");
            tes24.setForeground(Color.BLACK);
        }
    ...
    private void tes25ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes25ActionPerformed
        if (tes25.isSelected()) {
            tes25.setBackground(Color.BLACK);
            tes25.setText("T");
            tes25.setForeground(Color.WHITE);
        } else {
            tes25.setBackground(Color.WHITE);
            tes25.setText("F");
            tes25.setForeground(Color.BLACK);
        }
    ...
    private void tes26ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes26ActionPerformed
        if (tes26.isSelected()) {
            tes26.setBackground(Color.BLACK);
            tes26.setText("T");
            tes26.setForeground(Color.WHITE);
        } else {
            tes26.setBackground(Color.WHITE);
            tes26.setText("F");
            tes26.setForeground(Color.BLACK);
        }
    ...
    private void tes27ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes27ActionPerformed
        if (tes27.isSelected()) {
            tes27.setBackground(Color.BLACK);
            tes27.setText("T");
            tes27.setForeground(Color.WHITE);
        } else {
            tes27.setBackground(Color.WHITE);
            tes27.setText("F");
            tes27.setForeground(Color.BLACK);
        }
    ...
    private void tes28ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes28ActionPerformed
        if (tes28.isSelected()) {
            tes28.setBackground(Color.BLACK);
            tes28.setText("T");
            tes28.setForeground(Color.WHITE);
        } else {
            tes28.setBackground(Color.WHITE);
            tes28.setText("F");
            tes28.setForeground(Color.BLACK);
        }
    ...
    private void tes29ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes29ActionPerformed
        if (tes29.isSelected()) {
            tes29.setBackground(Color.BLACK);
            tes29.setText("T");
            tes29.setForeground(Color.WHITE);
        } else {
            tes29.setBackground(Color.WHITE);
            tes29.setText("F");
            tes29.setForeground(Color.BLACK);
        }
    ...
    private void tes30ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes30ActionPerformed
        if (tes30.isSelected()) {
            tes30.setBackground(Color.BLACK);
            tes30.setText("T");
            tes30.setForeground(Color.WHITE);
        } else {
            tes30.setBackground(Color.WHITE);
            tes30.setText("F");
            tes30.setForeground(Color.BLACK);
        }
    ...
    private void tes31ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes31ActionPerformed
        if (tes31.isSelected()) {
            tes31.setBackground(Color.BLACK);
            tes31.setText("T");
            tes31.setForeground(Color.WHITE);
        } else {
            tes31.setBackground(Color.WHITE);
            tes31.setText("F");
            tes31.setForeground(Color.BLACK);
        }
    ...
    private void tes32ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes32ActionPerformed
        if (tes32.isSelected()) {
            tes32.setBackground(Color.BLACK);
            tes32.setText("T");
            tes32.setForeground(Color.WHITE);
        } else {
            tes32.setBackground(Color.WHITE);
            tes32.setText("F");
            tes32.setForeground(Color.BLACK);
        }
    ...
    private void tes33ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes33ActionPerformed
        if (tes33.isSelected()) {
            tes33.setBackground(Color.BLACK);
            tes33.setText("T");
            tes33.setForeground(Color.WHITE);
        } else {
            tes33.setBackground(Color.WHITE);
            tes33.setText("F");
            tes33.setForeground(Color.BLACK);
        }
    ...
    private void tes34ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes34ActionPerformed
        if (tes34.isSelected()) {
            tes34.setBackground(Color.BLACK);
            tes34.setText("T");
            tes34.setForeground(Color.WHITE);
        } else {
            tes34.setBackground(Color.WHITE);
            tes34.setText("F");
            tes34.setForeground(Color.BLACK);
        }
    ...
    private void tes35ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes35ActionPerformed
        if (tes35.isSelected()) {
            tes35.setBackground(Color.BLACK);
            tes35.setText("T");
            tes35.setForeground(Color.WHITE);
        } else {
            tes35.setBackground(Color.WHITE);
            tes35.setText("F");
            tes35.setForeground(Color.BLACK);
        }
    ...
    private void tes36ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes36ActionPerformed
        if (tes36.isSelected()) {
            tes36.setBackground(Color.BLACK);
            tes36.setText("T");
            tes36.setForeground(Color.WHITE);
        } else {
            tes36.setBackground(Color.WHITE);
            tes36.setText("F");
            tes36.setForeground(Color.BLACK);
        }
    ...
    private void tes37ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes37ActionPerformed
        if (tes37.isSelected()) {
            tes37.setBackground(Color.BLACK);
            tes37.setText("T");
            tes37.setForeground(Color.WHITE);
        } else {
            tes37.setBackground(Color.WHITE);
            tes37.setText("F");
            tes37.setForeground(Color.BLACK);
        }
    ...
    private void tes38ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes38ActionPerformed
        if (tes38.isSelected()) {
            tes38.setBackground(Color.BLACK);
            tes38.setText("T");
            tes38.setForeground(Color.WHITE);
        } else {
            tes38.setBackground(Color.WHITE);
            tes38.setText("F");
            tes38.setForeground(Color.BLACK);
        }
    ...
    private void tes39ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes39ActionPerformed
        if (tes39.isSelected()) {
            tes39.setBackground(Color.BLACK);
            tes39.setText("T");
            tes39.setForeground(Color.WHITE);
        } else {
            tes39.setBackground(Color.WHITE);
            tes39.setText("F");
            tes39.setForeground(Color.BLACK);
        }
    ...
    private void tes40ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes40ActionPerformed
        if (tes40.isSelected()) {
            tes40.setBackground(Color.BLACK);
            tes40.setText("T");
            tes40.setForeground(Color.WHITE);
        } else {
            tes40.setBackground(Color.WHITE);
            tes40.setText("F");
            tes40.setForeground(Color.BLACK);
        }
    ...
    private void tes41ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes41ActionPerformed
        if (tes41.isSelected()) {
            tes41.setBackground(Color.BLACK);
            tes41.setText("T");
            tes41.setForeground(Color.WHITE);
        } else {
            tes41.setBackground(Color.WHITE);
            tes41.setText("F");
            tes41.setForeground(Color.BLACK);
        }
    ...
    private void tes42ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes42ActionPerformed
        if (tes42.isSelected()) {
            tes42.setBackground(Color.BLACK);
            tes42.setText("T");
            tes42.setForeground(Color.WHITE);
        } else {
            tes42.setBackground(Color.WHITE);
            tes42.setText("F");
            tes42.setForeground(Color.BLACK);
        }
    ...
    private void tes43ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes43ActionPerformed
        if (tes43.isSelected()) {
            tes43.setBackground(Color.BLACK);
            tes43.setText("T");
            tes43.setForeground(Color.WHITE);
        } else {
            tes43.setBackground(Color.WHITE);
            tes43.setText("F");
            tes43.setForeground(Color.BLACK);
        }
    ...
    private void tes44ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes44ActionPerformed
       if (tes44.isSelected()) {
            tes44.setBackground(Color.BLACK);
            tes44.setText("T");
            tes44.setForeground(Color.WHITE);
        } else {
            tes44.setBackground(Color.WHITE);
            tes44.setText("F");
            tes44.setForeground(Color.BLACK);
        }
    ...
    private void tes45ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes45ActionPerformed
        if (tes45.isSelected()) {
            tes45.setBackground(Color.BLACK);
            tes45.setText("T");
            tes45.setForeground(Color.WHITE);
        } else {
            tes45.setBackground(Color.WHITE);
            tes45.setText("F");
            tes45.setForeground(Color.BLACK);
        }
    ...
    private void tes46ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes46ActionPerformed
        if (tes46.isSelected()) {
            tes46.setBackground(Color.BLACK);
            tes46.setText("T");
            tes46.setForeground(Color.WHITE);
        } else {
            tes46.setBackground(Color.WHITE);
            tes46.setText("F");
            tes46.setForeground(Color.BLACK);
        }
    ...
    private void tes47ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes47ActionPerformed
        if (tes47.isSelected()) {
            tes47.setBackground(Color.BLACK);
            tes47.setText("T");
            tes47.setForeground(Color.WHITE);
        } else {
            tes47.setBackground(Color.WHITE);
            tes47.setText("F");
            tes47.setForeground(Color.BLACK);
        }
    ...
    private void tes48ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes48ActionPerformed
        if (tes48.isSelected()) {
            tes48.setBackground(Color.BLACK);
            tes48.setText("T");
            tes48.setForeground(Color.WHITE);
        } else {
            tes48.setBackground(Color.WHITE);
            tes48.setText("F");
            tes48.setForeground(Color.BLACK);
        }
    ...
    private void tes49ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes49ActionPerformed
       if (tes49.isSelected()) {
            tes49.setBackground(Color.BLACK);
            tes49.setText("T");
            tes49.setForeground(Color.WHITE);
        } else {
            tes49.setBackground(Color.WHITE);
            tes49.setText("F");
            tes49.setForeground(Color.BLACK);
        }
    ...
    private void tes50ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes50ActionPerformed
        if (tes50.isSelected()) {
            tes50.setBackground(Color.BLACK);
            tes50.setText("T");
            tes50.setForeground(Color.WHITE);
        } else {
            tes50.setBackground(Color.WHITE);
            tes50.setText("F");
            tes50.setForeground(Color.BLACK);
        }
    ...
    private void tes51ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes51ActionPerformed
       if (tes51.isSelected()) {
            tes51.setBackground(Color.BLACK);
            tes51.setText("T");
            tes51.setForeground(Color.WHITE);
        } else {
            tes51.setBackground(Color.WHITE);
            tes51.setText("F");
            tes51.setForeground(Color.BLACK);
        }
    ...
    private void tes52ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes52ActionPerformed
        if (tes52.isSelected()) {
            tes52.setBackground(Color.BLACK);
            tes52.setText("T");
            tes52.setForeground(Color.WHITE);
        } else {
            tes52.setBackground(Color.WHITE);
            tes52.setText("F");
            tes52.setForeground(Color.BLACK);
        }
    ...
    private void tes53ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes53ActionPerformed
        if (tes53.isSelected()) {
            tes53.setBackground(Color.BLACK);
            tes53.setText("T");
            tes53.setForeground(Color.WHITE);
        } else {
            tes53.setBackground(Color.WHITE);
            tes53.setText("F");
            tes53.setForeground(Color.BLACK);
        }
    ...
    private void tes54ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes54ActionPerformed
        if (tes54.isSelected()) {
            tes54.setBackground(Color.BLACK);
            tes54.setText("T");
            tes54.setForeground(Color.WHITE);
        } else {
            tes54.setBackground(Color.WHITE);
            tes54.setText("F");
            tes54.setForeground(Color.BLACK);
        }
    ...
    private void tes55ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes55ActionPerformed
        if (tes55.isSelected()) {
            tes55.setBackground(Color.BLACK);
            tes55.setText("T");
            tes55.setForeground(Color.WHITE);
        } else {
            tes55.setBackground(Color.WHITE);
            tes55.setText("F");
            tes55.setForeground(Color.BLACK);
        }
    ...
    private void tes56ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes56ActionPerformed
        if (tes56.isSelected()) {
            tes56.setBackground(Color.BLACK);
            tes56.setText("T");
            tes56.setForeground(Color.WHITE);
        } else {
            tes56.setBackground(Color.WHITE);
            tes56.setText("F");
            tes56.setForeground(Color.BLACK);
        }
    ...
    private void tes57ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes57ActionPerformed
       if (tes57.isSelected()) {
            tes57.setBackground(Color.BLACK);
            tes57.setText("T");
            tes57.setForeground(Color.WHITE);
        } else {
            tes57.setBackground(Color.WHITE);
            tes57.setText("F");
            tes57.setForeground(Color.BLACK);
        }
    ...
    private void tes58ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes58ActionPerformed
       if (tes58.isSelected()) {
            tes58.setBackground(Color.BLACK);
            tes58.setText("T");
            tes58.setForeground(Color.WHITE);
        } else {
            tes58.setBackground(Color.WHITE);
            tes58.setText("F");
            tes58.setForeground(Color.BLACK);
        }
    ...
    private void tes59ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes59ActionPerformed
        if (tes59.isSelected()) {
            tes59.setBackground(Color.BLACK);
            tes59.setText("T");
            tes59.setForeground(Color.WHITE);
        } else {
            tes59.setBackground(Color.WHITE);
            tes59.setText("F");
            tes59.setForeground(Color.BLACK);
        }
    ...
    private void tes60ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes60ActionPerformed
        if (tes60.isSelected()) {
            tes60.setBackground(Color.BLACK);
            tes60.setText("T");
            tes60.setForeground(Color.WHITE);
        } else {
            tes60.setBackground(Color.WHITE);
            tes60.setText("F");
            tes60.setForeground(Color.BLACK);
        }
    ...
    private void tes61ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes61ActionPerformed
        if (tes61.isSelected()) {
            tes61.setBackground(Color.BLACK);
            tes61.setText("T");
            tes61.setForeground(Color.WHITE);
        } else {
            tes61.setBackground(Color.WHITE);
            tes61.setText("F");
            tes61.setForeground(Color.BLACK);
        }
    ...
    private void tes62ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes62ActionPerformed
        if (tes62.isSelected()) {
            tes62.setBackground(Color.BLACK);
            tes62.setText("T");
            tes62.setForeground(Color.WHITE);
        } else {
            tes62.setBackground(Color.WHITE);
            tes62.setText("F");
            tes62.setForeground(Color.BLACK);
        }
    ...
    private void tes63ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes63ActionPerformed
        if (tes63.isSelected()) {
            tes63.setBackground(Color.BLACK);
            tes63.setText("T");
            tes63.setForeground(Color.WHITE);
        } else {
            tes63.setBackground(Color.WHITE);
            tes63.setText("F");
            tes63.setForeground(Color.BLACK);
        }
    ...
    private void tes16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tes16ActionPerformed
       if (tes16.isSelected()) {
            tes16.setBackground(Color.BLACK);
            tes16.setText("T");
            tes16.setForeground(Color.WHITE);
        } else {
            tes16.setBackground(Color.WHITE);
            tes16.setText("F");
            tes16.setForeground(Color.BLACK);
        }
